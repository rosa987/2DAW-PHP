...
var_dump ($carton);echo "</BR>";
//-------------------------------Carton2----------------------------------------
$carton2 = array();
$i=0;
echo "Jugador 1.Carton2"."</BR>";echo "===========" . "</BR>";
        while($i < 15){
...
var_dump ($carton2);echo "</BR>";

//-------------------------------Carton3----------------------------------------
$carton3 = array();
$i=0;
echo "Jugador 1.Carton3"."</BR>";echo "===========" . "</BR>";
        while($i < 15){
	
	$numCarton=rand(1,60);
	
	if(in_array($numCarton,$carton3) === false){
		
		array_push($carton3,$numCarton);
